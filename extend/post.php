...
$apikey = "087e693857ce412163873b4b5e7c0d3f"; //修改为您的apikey(https://www.yunpian.com)登录官网后获取
$mobile = $_POST['mobile'];
// $mobile = "xxxxxxxx"; //请用自己的手机号代替
$num = rand(1000, 9999);
...
$data = array('tpl_id' => '1', 'tpl_value' => ('#code#') .
    '=' . urlencode($num) .
    '&' . urlencode('#company#') .
    '=' . urlencode('刘皓璇'), 'apikey' => $apikey, 'mobile' => $mobile);
// print_r ($data);
...
$tpl_id = '2606974'; //你自己后台报备的模板id
$tpl_value = urlencode('#time#') . '=' . urlencode($num) . '&' . urlencode('#name#') . '=' . urlencode('刘皓璇');
